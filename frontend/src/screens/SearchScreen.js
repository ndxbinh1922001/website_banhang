    ...
    const fetchData = async () => {
      try {
        const { data } = await axios.get(
          `${apiUrl}/api/products/search?page=${page}&query=${query}&category=${category}&price=${price}&rating=${rating}&order=${order}`
        );
              ...
              <Row className="justify-content-between mb-3">
                ...
                <Col className="text-end">
                  ...
                  >
                    ...
                    <option value="lowest">Giá: từ thấp lên cao</option>
